...
const SOCIAL_LINKS = [
  {
    name: 'GitHub',
    link: 'https://github.com/IranoLincolnJA',
  },
  {
    name: 'LinkedIn',
    link: 'https://www.linkedin.com/in/lincoln-irano-b1574ba1/',
  },
];
        ...
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
              ...
              <P>Ao lado voce pode inserir diferentes jogos, categorias, editoras para a nossa maravilhosa loja de jogos!</P>
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              ...
              <P style={{ marginTop: 7, marginBottom: 0 }}>Em caso de duvidas e/ou sugestões, só entrar em contato através de nossos links</P>
              <ALink
